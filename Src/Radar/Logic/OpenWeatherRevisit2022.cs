...
using Radar.JsonResults;
using Radar.JsonResults.XML;
...
internal class OpenWeatherRevisit2022
{
    ...
    string frmt = "json") // XML gives readable time for sunrise!!!
  {
    try
    {
      ...
      */
        $"https://api.openweathermap.org/data/2.5/weather?q={city}&units=metric&mode={frmt}&appid={code}";              // https://openweathermap.org/Rootobject       
